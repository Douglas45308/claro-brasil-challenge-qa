...
public class AdicionarProdutoAoCarrinhoObjects {

	private WebDriver driver;

	public AdicionarProdutoAoCarrinhoObjects(WebDriver driver) {
		this.driver = driver;
	}

	public WebElement adicionarCarrinho() {
		return this.driver.findElement(By.xpath("//span[contains(text(),'Add to cart')]"));
	...
	public WebElement fazerCheckoutResumo() {
